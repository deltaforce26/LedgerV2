...
namespace LedgerV2.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class LedgersController : ControllerBase
    {
        private readonly LedgerV2Context _context;

        public LedgersController(LedgerV2Context context)
        {
            _context = context;
        }
        ...
        [HttpPut]
        public async Task<IActionResult> AddUser(int userId, int ledgerId)
        {
